...
export default function ProfileScreen({ navigation, route, props }) {
  ...
  const sla = async () => {
    ...
    console.log("USUÁRIO ESTÁ VERIFICADO? ", auth.currentUser.emailVerified);
  ...
  if (!fontsLoaded) {
    ...
    return (
      ...
      >
        <StatusBar animated={true} backgroundColor="#9D0208" />
        {loading && !isVisible && (
        ...
        {!loading && isVisible && (
          <View style={styles.content}>
            ...
            <View style={styles.body}>
              ...
              <View
                style={[styles.itemArea, { marginTop: 35, marginBottom: 35 }]}
              >
                <TouchableOpacity
